        ...
        <table class="table table-bordered text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td v-for="e in Array(3)" :key="e">
                <span class="bg-brown activity-name">Happy Lunch</span>
            ...
            <tr>
              ...
              <td class="bg-light-gray" v-for="e in Array(4)" :key="e"></td>
              <td>
