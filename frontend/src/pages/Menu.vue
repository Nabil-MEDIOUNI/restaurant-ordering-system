          ...
          <ul class="filter-option">
            <li>
              ...
              <label for="bsStatus" class="d-flex justify-content-between"
                >Best Seller
                <button class="unselect-btn" @click="unselectStatusBtn($event)" value="Best Seller">
                  X
                </button></label
              >
            </li>
            ...
            <li>
              ...
              <label for="ooStatus" class="d-flex justify-content-between"
                >Online Only
                <button class="unselect-btn" @click="unselectStatusBtn($event)" value="Online Only">
                  X
                </button></label
              >
            </li>
            ...
            <li>
              ...
              <label for="soStatus" class="d-flex justify-content-between"
                >Sale Off
                <button class="unselect-btn" @click="unselectStatusBtn($event)" value="Sale Off">
                  X
                </button></label
              >
            </li>
            ...
            <li>
              ...
              <label for="ndStatus" class="d-flex justify-content-between"
                >New Dishes
                <button class="unselect-btn" @click="unselectStatusBtn($event)" value="New Dishes">
                  X
                </button></label
              >
            </li>
          ...
          <ul class="filter-option">
            <li>
              ...
              <label for="rtfPrice" class="d-flex justify-content-between"
                >$2 - $5
                <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label
              >
            </li>
          ...
          <ul class="filter-option">
            <li>
              ...
              <label for="mType" class="d-flex justify-content-between"
                >meat<button class="unselect-btn" @click="unselectTypeBtn($event)">X</button></label
              >
            </li>
            ...
            <li>
              ...
              <label for="vType" class="d-flex justify-content-between"
                >vegan<button class="unselect-btn" @click="unselectTypeBtn($event)">
                  X
                </button></label
              >
            </li>
            ...
            <div class="box">
              ...
              <div class="content">
                ...
                <div class="stars">
                  ...
                  <div
                    v-if="parseFloat(f.food_star) - Math.floor(parseFloat(f.food_star)) == 0.5"
                    class="d-inline"
                  >
  ...
  methods: {
    ...
    filterPriceBtn: function (e) {
      ...
      if (this.previousPriceClicked != '') {
        document.querySelector(`[for=${this.previousPriceClicked.target.id}]`).style.background =
          'inherit';
        document.querySelector(`[for=${this.previousPriceClicked.target.id}]`).style.color =
          'inherit';
        document
    ...
    filterTypeBtn: function (e) {
      ...
      if (this.previousTypeClicked != '') {
        document.querySelector(`[for=${this.previousTypeClicked.target.id}]`).style.background =
          'inherit';
        document.querySelector(`[for=${this.previousTypeClicked.target.id}]`).style.color =
          'inherit';
        document
