<template>
  <div class="thank-container">
    ...
    <div class="thank-letter">
      ...
      <p v-none>
        We have just confirmed you received your order, and hope you are enjoying it. Every item is
        handmade by our team, with care to the details, so we can always provide you with the best
        experience.
      </p>
...
.thank-container h1 p span {
  ...
  font-size: 80px;
  color: #fff;
  text-shadow: 0 1px 0 #20884b, 0 2px 0 #20884b, 0 3px 0 #20884b, 0 4px 0 #20884b, 0 5px 0 #20884b,
...
@-webkit-keyframes bounce {
  100% {
    top: -20px;
    text-shadow: 0 1px 0 #20884b, 0 2px 0 #20884b, 0 3px 0 #20884b, 0 4px 0 #20884b, 0 5px 0 #20884b,
      0 6px 0 #20884b, 0 7px 0 #20884b, 0 8px 0 #20884b, 0 9px 0 #20884b,
