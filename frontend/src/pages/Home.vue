  ...
  <div>
    <div class="home-main">
      <div class="content">
        ...
        <p>
          We guarantee to use fresh food with the best quality. Customers will enjoy Mexican cuisine
          with explosive, sophisticated flavors.
        </p>
    ...
    <div class="home-about">
      ...
      <div class="content">
        ...
        <p>
          ...
          Quang (a 5 Michelin stars chef), promising to bring explosive, delicate, impressive
          flavors. Our delivery service is very professional, customers can enjoy the same quality
          at the restaurant
        </p>
